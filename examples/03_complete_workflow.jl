...
println("    ✓ Abstract types: ", ma.has_abstract_types ? "❌ YES" : "✅ NO")
println("    ✓ Specialization factor: ", round(ma.specialization_factor, digits=2))

println("  Escape Analysis:")
println("    ✓ Allocations: ", length(ea.allocations) == 0 ? "✅ None" : "❌ $(length(ea.allocations))")

println("  Devirtualization:")
println("    ✓ Dynamic calls: ", da.total_dynamic_calls == 0 ? "✅ None" : "⚠️  $(da.total_dynamic_calls)")
