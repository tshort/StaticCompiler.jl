...
println("-"^70)
println("OK c\"...\" for static strings (no heap allocation)")
println("OK println() from StaticTools (minimal I/O)")
println("OK No dynamic allocations")
println()
...
println()
println("Trade-offs:")
println("  OK Smaller on disk")
println("  OK Smaller for distribution")
println("  FAIL Slower startup (decompression)")
println("  FAIL Higher memory usage during execution")
println()
...
println("  OK Use StaticTools for minimal I/O")
println("  OK Apply -Os for size optimization")
println("  OK Strip debug symbols after compilation")
println("  OK Use -flto for link-time optimization")
println("  OK Use --gc-sections to remove unused code")
println("  OK Consider UPX for distribution")
println()
