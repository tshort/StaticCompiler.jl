...
@testset "Multiple Function Dylibs" begin
    ...
    @test ccall(fptr2, Float64, (Float64,), 10.0) == squaresquare(10.0)

    fptr = Libdl.dlsym(ptr, "squaresquaresquare")
    @test ccall(fptr, Float64, (Float64,), 10.0) == squaresquaresquare(10.0)
    #Compile dylib
end
